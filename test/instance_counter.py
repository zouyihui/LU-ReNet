...
class InstanceCounter(nn.Module):
    ...
    def __generate_cnn(self):
        if self.use_coordinates:
            ...
            self.cnn.add_module('conv1', CoordConv(self.input_n_filters,
                                                self.n_filters,
                                                kernel_size=(3, 3),
                                                stride=(1, 1),
                                                padding=(1, 1)))
            self.cnn.add_module('relu1', nn.ReLU())
            self.cnn.add_module('conv2', CoordConv(self.n_filters,
                                               self.n_filters,
                                               kernel_size=(3, 3),
                                               stride=(1, 1),
                                               padding=(1, 1)))
            ...
            self.cnn.add_module('conv3', CoordConv(self.n_filters,
                                               self.n_filters,
                                               kernel_size=(3, 3),
                                               stride=(1, 1),
                                               padding=(1, 1)))
            self.cnn.add_module('relu3', nn.ReLU())
            self.cnn.add_module('conv4', CoordConv(self.n_filters,
                                               self.n_filters,
                                               kernel_size=(3, 3),
                                               stride=(1, 1),
                                               padding=(1, 1)))
